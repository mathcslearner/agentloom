...
var routeClasses = map[string]routeClass{
	...
	"POST /v1/events/ws-ticket":                    classRead,
	"GET /v1/events/ws":                            classRead,
	...
	"GET /v1/approvals":                            classRead,
	"POST /v1/approvals/{approvalID}:decide":       classSubmit,
	"GET /v1/auth/whoami":                          classRead,
	"GET /v1/dead-letters":                         classRead,
	"GET /v1/system/stats":                         classRead,
