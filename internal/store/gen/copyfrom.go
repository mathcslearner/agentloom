...
func (q *Queries) CreateRunSteps(ctx context.Context, arg []CreateRunStepsParams) (int64, error) {
	return q.db.CopyFrom(ctx, []string{"run_steps"}, []string{"run_id", "step_id", "step_type", "config", "retry_policy", "timeout", "cache_policy", "budget_policy", "status", "remaining_deps", "fired_deps", "graph_version", "updated_at"}, &iteratorForCreateRunSteps{rows: arg})
}
