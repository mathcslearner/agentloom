...
func (q *Queries) BudgetParkRunStep(ctx context.Context, arg BudgetParkRunStepParams) (RunStep, error) {
	row := q.db.QueryRow(ctx, budgetParkRunStep,
		arg.Now,
		arg.RunID,
		arg.StepID,
		arg.ClaimID,
...
const semanticRetryRunStep = `-- name: SemanticRetryRunStep :one
UPDATE run_steps
SET status          = 'retrying',
    error           = $1,
    claim_id        = NULL,
...
func (q *Queries) SemanticRetryRunStep(ctx context.Context, arg SemanticRetryRunStepParams) (RunStep, error) {
	row := q.db.QueryRow(ctx, semanticRetryRunStep,
		arg.Error,
		arg.NextAttemptAt,
		arg.Feedback,
		arg.Now,
